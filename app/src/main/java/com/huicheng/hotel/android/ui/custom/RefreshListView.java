...
//    private ImageView ivArrow; // 头布局的剪头
    private ProgressWheel mProgressBar; // 头布局的进度条
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.refresh_list_footerview, null);
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.refresh_list_headview, null);
//        ivArrow = (ImageView) headerView
//                .findViewById(R.id.iv_listview_header_arrow);
        mProgressBar = (ProgressWheel) headerView
