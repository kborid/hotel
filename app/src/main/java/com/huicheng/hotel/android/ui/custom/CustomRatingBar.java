...
public class CustomRatingBar extends View {
    ...
    public void setStarEmptyDrawable(Drawable dw) {
        starEmptyDrawable = dw;
        invalidate();
    }

    public void setStarFillDrawable(Drawable dw) {
        starFillBitmap = drawableToBitmap(dw);
        paint.setShader(new BitmapShader(starFillBitmap, BitmapShader.TileMode.CLAMP, BitmapShader.TileMode.CLAMP));
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = (int) starMark; i < starCount; i++) {
    ...
    public void setCanTouch(boolean isflag) {
        isCanTouch = isflag;
    }
