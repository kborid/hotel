 ...
 * @date 2017/4/11 0011
 */
public class HotelSpaceSubCommentAdapter extends BaseAdapter implements DataCallback {
    ...
    public HotelSpaceSubCommentAdapter(Context context, List<HotelSpaceTieCommentInfoBean> list) {
