...
public class HotelSpacePublishActivity extends BaseAppActivity {
    ...
    private void goAt() {
        ...
        Intent intent = new Intent(this, HotelAttendPersonActivity.class);
        intent.putExtra(HotelAttendPersonActivity.KEY_SELECTED, tmp.toString());
...
//                String tmpCidStr = data.getStringExtra(HotelAttendPersonActivity.KEY_CID);
//                String tmpNameStr = data.getStringExtra(HotelAttendPersonActivity.KEY_NAME);
