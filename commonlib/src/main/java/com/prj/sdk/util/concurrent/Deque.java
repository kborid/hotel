 ...
 * 
 * <p>
 * A typical deque does not allow null to be inserted as its element, while some implementations allow it. But null should not be inserted even in these implementations, since method poll return null
 * to indicate that there is no element left in the deque.
 * 
 * <p>
...
public interface Deque<E> extends Queue<E> {
	...
	/**
	 * Inserts an element at the head of this deque unless it would violate size limit. It is better than the addFirst(E) method in a size-limited deque, because the latter one may fail to add the
	...
	/**
	 * Inserts an element at the tail of this deque unless it would violate size limit. It is better than the addLast(E) method in a size-limited deque, because the latter one may fail to add the
	 * element only by throwing an exception.
	 * 
	 * @param e
	 *            the element
